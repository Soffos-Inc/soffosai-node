...
var ChatBotIO = /*#__PURE__*/function (_ServiceIO) {
  _inherits(ChatBotIO, _ServiceIO);
  var _super = _createSuper(ChatBotIO);
  function ChatBotIO() {
    var _this;
    _classCallCheck(this, ChatBotIO);
  ...
  return _createClass(ChatBotIO);
}(_service_io["default"]);
var _default = ChatBotIO;
