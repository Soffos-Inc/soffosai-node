...
var SentimentAnalysisIO = /*#__PURE__*/function (_ServiceIO) {
  _inherits(SentimentAnalysisIO, _ServiceIO);
  var _super = _createSuper(SentimentAnalysisIO);
  function SentimentAnalysisIO() {
    var _this;
    _classCallCheck(this, SentimentAnalysisIO);
  ...
  return _createClass(SentimentAnalysisIO);
}(_service_io["default"]);
var _default = SentimentAnalysisIO;
