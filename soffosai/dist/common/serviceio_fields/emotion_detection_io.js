...
var EmotionDetectionIO = /*#__PURE__*/function (_ServiceIO) {
  _inherits(EmotionDetectionIO, _ServiceIO);
  var _super = _createSuper(EmotionDetectionIO);
  function EmotionDetectionIO() {
    var _this;
    _classCallCheck(this, EmotionDetectionIO);
  ...
  _createClass(EmotionDetectionIO, [{
    ...
    value: function special_validation(payload) {
      ...
      return _get(_getPrototypeOf(EmotionDetectionIO.prototype), "special_validation", this).call(this, payload);
    }
  }]);
  return EmotionDetectionIO;
}(_service_io["default"]);
var _default = EmotionDetectionIO;
