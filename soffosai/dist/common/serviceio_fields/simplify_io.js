...
var SimplifyIO = /*#__PURE__*/function (_ServiceIO) {
  _inherits(SimplifyIO, _ServiceIO);
  var _super = _createSuper(SimplifyIO);
  function SimplifyIO() {
    var _this;
    _classCallCheck(this, SimplifyIO);
  ...
  return _createClass(SimplifyIO);
}(_service_io["default"]);
var _default = SimplifyIO;
