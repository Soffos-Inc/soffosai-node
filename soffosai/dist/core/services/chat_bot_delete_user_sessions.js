 ...
 */
var ChatBotDeleteUserSessionsService = /*#__PURE__*/function (_SoffosAIService) {
  _inherits(ChatBotDeleteUserSessionsService, _SoffosAIService);
  var _super = _createSuper(ChatBotDeleteUserSessionsService);
  function ChatBotDeleteUserSessionsService() {
    var _this;
    var kwargs = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    _classCallCheck(this, ChatBotDeleteUserSessionsService);
    var service = _constants.ServiceString.CHAT_BOT_DELETE_USER_SESSIONS;
    _this = _super.call(this, service, kwargs);
    _this._serviceio = new _index.ChatBotDeleteUserSessionsIO();
    return _this;
  }
  ...
  _createClass(ChatBotDeleteUserSessionsService, [{
    key: "call",
    value: function call(user, chatbot_id, user_id) {
      var session_ids = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
      var payload = {
        "user": user,
      ...
      return _get(_getPrototypeOf(ChatBotDeleteUserSessionsService.prototype), "call", this).call(this, payload);
    }
    ...
    key: "setInputConfigs",
    value: function setInputConfigs(name, chatbot_id, user_id) {
      var session_ids = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
      var source = {
        "chatbot_id": chatbot_id,
        "user_id": user_id
      ...
      if (session_ids) payload.session_ids = session_ids;
      return _get(_getPrototypeOf(ChatBotDeleteUserSessionsService.prototype), "setInputConfigs", this).call(this, name, source);
    }
  }]);
  return ChatBotDeleteUserSessionsService;
}(_service.SoffosAIService);
var _default = ChatBotDeleteUserSessionsService;
