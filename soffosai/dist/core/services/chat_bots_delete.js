 ...
 */
var ChatBotsDeleteService = /*#__PURE__*/function (_SoffosAIService) {
  _inherits(ChatBotsDeleteService, _SoffosAIService);
  var _super = _createSuper(ChatBotsDeleteService);
  function ChatBotsDeleteService() {
    var _this;
    var kwargs = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    _classCallCheck(this, ChatBotsDeleteService);
    var service = _constants.ServiceString.CHAT_BOTS_DELETE;
    _this = _super.call(this, service, kwargs);
    _this._serviceio = new _index.ChatBotsDeleteIO();
    return _this;
  }
   ...
   */
  _createClass(ChatBotsDeleteService, [{
    key: "call",
    value: function call(user, chatbot_ids) {
      var payload = {
        "user": user,
        "chatbot_ids": chatbot_ids
      };
      return _get(_getPrototypeOf(ChatBotsDeleteService.prototype), "call", this).call(this, payload);
    }
    ...
    key: "setInputConfigs",
    value: function setInputConfigs(name, chatbot_ids) {
      var source = {
        "chatbot_ids": chatbot_ids
      };
      return _get(_getPrototypeOf(ChatBotsDeleteService.prototype), "setInputConfigs", this).call(this, name, source);
    }
  }]);
  return ChatBotsDeleteService;
}(_service.SoffosAIService);
var _default = ChatBotsDeleteService;
