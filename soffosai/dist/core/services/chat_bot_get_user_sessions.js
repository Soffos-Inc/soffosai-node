 ...
 */
var ChatBotGetUserSessionsService = /*#__PURE__*/function (_SoffosAIService) {
  _inherits(ChatBotGetUserSessionsService, _SoffosAIService);
  var _super = _createSuper(ChatBotGetUserSessionsService);
  function ChatBotGetUserSessionsService() {
    var _this;
    var kwargs = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    _classCallCheck(this, ChatBotGetUserSessionsService);
    var service = _constants.ServiceString.CHAT_BOT_GET_USER_SESSIONS;
    _this = _super.call(this, service, kwargs);
    _this._serviceio = new _index.ChatBotGetUserSessionsIO();
    return _this;
  }
  ...
  _createClass(ChatBotGetUserSessionsService, [{
    ...
    value: function call(user, chatbot_id, user_id) {
      ...
      return _get(_getPrototypeOf(ChatBotGetUserSessionsService.prototype), "call", this).call(this, payload);
    }
    ...
    value: function setInputConfigs(name, chatbot_id, user_id) {
      ...
      if (session_ids) payload.session_ids = session_ids;
      return _get(_getPrototypeOf(ChatBotGetUserSessionsService.prototype), "setInputConfigs", this).call(this, name, source);
    }
  }]);
  return ChatBotGetUserSessionsService;
}(_service.SoffosAIService);
var _default = ChatBotGetUserSessionsService;
